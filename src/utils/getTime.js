...
export const getTimeCapsule = () => {
  ...
  return [
    {data: getDifference("day"), tag: 'day'},
    {data: getDifference("week"), tag: 'week'},
    {data: getDifference("month"), tag: 'month'},
    {data: getDifference("year"), tag: 'year'}
  ];
};
