    ...
    function xb(a, b, e, f) {
      ...
      if (!f && 1 === m.length) {
        if (
          ...
          if (
            ((b = (d.find.ID(j.matches[0].replace(ab, bb), b) || [])[0]), !b)
          ) {
            return e;
          }
...
(function () {
  ...
  (s.reduce =
    ...
    (s.reduceRight = s.foldr =
      function (G, K, J, H) {
        var P = arguments.length > 2;
        if ((null == G && (G = []), S && G.reduceRight === S)) {
          return (
            H && (K = s.bind(K, H)), P ? G.reduceRight(K, J) : G.reduceRight(K)
          );
        }
        var L = G.length;
        if (L !== +L) {
        ...
        if (
          (e(G, function (V, U, Q) {
            (U = C ? C[--L] : --L),
              P ? (J = K.call(H, J, G[U], U, Q)) : ((J = G[U]), (P = !0));
          }),
          !P)
        ) {
          throw new TypeError(z);
  ...
  (s.contains = s.include =
    ...
    (s.sample = function (H, G, C) {
      return null == G || C
        ? (H.length !== +H.length && (H = s.values(H)),
          H[s.random(H.length - 1)])
        : s.shuffle(H).slice(0, Math.max(0, G));
    });
  var k = function (C) {
  ...
  (s.groupBy = o(function (H, G, C) {
    ...
    (s.last = function (H, G, C) {
      return null == H
        ...
        : null == G || C
        ? H[H.length - 1]
        : A.call(H, Math.max(H.length - G, 0));
    }),
    (s.rest =
      s.tail =
      s.drop =
  ...
  var v = function (H, G, C) {
    return G && s.every(H, s.isArray)
      ? i.apply(C, H)
      : (e(H, function (J) {
          s.isArray(J) || s.isArguments(J)
            ? G
              ? d.apply(C, J)
              : v(J, G, C)
            : C.push(J);
  ...
  (s.flatten = function (C, G) {
    ...
    (s.uniq = s.unique =
      function (G, K, J, H) {
        ...
        return (
          e(P, function (Q, U) {
            (K ? U && C[C.length - 1] === Q : s.contains(C, Q)) ||
              (C.push(Q), L.push(G[U]));
          }),
          L
        );
    ...
    (s.zip = function () {
      for (
        var H = s.max(s.pluck(arguments, "length").concat(0)),
          G = new Array(H),
          C = 0;
        H > C;
        C++
    ...
    (s.range = function (H, L, K) {
      ...
      for (
        var J = Math.max(Math.ceil((L - H) / K), 0), G = 0, C = new Array(J);
        J > G;
  ...
  (s.bind = function (H, G) {
        ...
        return (
          ...
          0 >= W
            ? (clearTimeout(H),
              ...
              (L = P.apply(K, G)),
              (K = G = null))
            : H || U.trailing === !1 || (H = setTimeout(J, W)),
          L
        );
      };
    }),
    (s.debounce = function (P, C, U) {
      var K,
        ...
        J = function () {
          ...
          C > V
            ? (K = setTimeout(J, C - V))
            : ((K = null), U || ((Q = P.apply(L, G)), (L = G = null)));
        };
      return function () {
    ...
    (s.once = function (H) {
      ...
      return function () {
        return C
          ? G
          : ((C = !0), (G = H.apply(this, arguments)), (H = null), G);
      };
    }),
    (s.wrap = function (C, G) {
    ...
    (s.values = function (H) {
      for (
        var C = s.keys(H), K = C.length, J = new Array(K), G = 0;
        K > G;
        G++
      ) {
        J[G] = H[C[G]];
    ...
    (s.extend = function (C) {
      return (
        e(A.call(arguments, 1), function (G) {
          if (G) {
            for (var H in G) {
              C[H] = G[H];
            }
    ...
    switch (G) {
      ...
      case "[object RegExp]":
        return (
          Q.source == C.source &&
          Q.global == C.global &&
          Q.multiline == C.multiline &&
          Q.ignoreCase == C.ignoreCase
        );
    }
  ...
  (s.isEqual = function (C, G) {
    ...
    s.isArguments(arguments) ||
      (s.isArguments = function (C) {
        return !(!C || !s.has(C, "callee"));
      }),
    "function" != typeof /./ &&
      (s.isFunction = function (C) {
  ...
  (s.template = function (P, C, U) {
    ...
    P.replace(G, function (Z, W, Y, V, X) {
      return (
        (H += P.slice(L, X).replace(h, function (aa) {
          return "\\" + f[aa];
        })),
    ...
    return (
      (J.source = "function(" + (U.variable || "obj") + "){\n" + H + "}"), J
    );
  }),
    (s.chain = function (C) {
      return s(C).chain();
    ...
    a = {
      ...
      pause: function () {
        (this._pause = !0),
          ...
          c.dialog.show(),
          (AdObj =
            '<a href="{url}"  class="btn btn-restart" style="text-decoration: none;">{title}</a>');
        ADs = [];
      ...
      tick: function () {
        return this._pause
          ...
          : (this.time--,
            ...
            this.time < 0
              ? void this.gameOver()
              : void c.time.text(parseInt(this.time)));
      },
      renderMap: function () {
        if (!this._pause) {
        ...
        var f =
          Game.lastLv > 0
            ? "我闯过" +
              ...
              Game.lastGameTxt +
              "！不服來战！"
            : "保护眼睛，16关以下不要再玩手机了！"; //DouyaGame.resetShareText(f);
      },
      reset: function () {
